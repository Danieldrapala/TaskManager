...
\fancypagestyle{figurespis}{
	\fancyhf{}									% wyczyść stopki i nagłówki
	\fancyhead[RO]{								% Prawy, nieparzysty nagłówek
		\hrulefill \hspace{16pt} \large Spis ilustracji \thechapter
		\put(-472.1, 12.1){%
			\makebox(0,0)[l]{%
				\includegraphics[width=0.05\textwidth]{pwr-logo}
			}
	...
	\fancyhead[LE]{								% Lewy, parzysty nagłówek
		\large Spis ilustracji  \hspace{16pt} \hrulefill 
		\put(-22, 12.1){%
			\makebox(0,0)[l]{%
				\includegraphics[width=0.05\textwidth]{wppt-logo}
			}
...
\fancypagestyle{listingsSpis}{
	\fancyhf{}									% wyczyść stopki i nagłówki
	\fancyhead[RO]{								% Prawy, nieparzysty nagłówek
		\hrulefill \hspace{16pt} \large Spis kodów źródłowych \thechapter
		\put(-472.1, 12.1){%
			\makebox(0,0)[l]{%
				\includegraphics[width=0.05\textwidth]{pwr-logo}
			}
	...
	\fancyhead[LE]{								% Lewy, parzysty nagłówek
		\large Spis kodów źródłowych  \hspace{16pt} \hrulefill 
		\put(-22, 12.1){%
			\makebox(0,0)[l]{%
				\includegraphics[width=0.05\textwidth]{wppt-logo}
			}
...
\blankpage
	...
	\input{analizaproblemu}
	\cleardoublepage

	\input{projektaplikacji}
	\cleardoublepage
	
	\input{interfejsuzytkownika}
	\cleardoublepage
	...
	\cleardoublepage
	\pagestyle{figurespis}
	\listoffigures
	    \addcontentsline{toc}{chapter}{Spis rysunków}
	\cleardoublepage
		\pagestyle{listingsSpis}
	\lstlistoflistings
