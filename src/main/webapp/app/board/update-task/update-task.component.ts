...
//       this.boardServiceImpl.taskIdData.subscribe((data: number) => {
//         this.taskId = data;
//         if (this.taskId !== undefined) {
//           this.boardServiceImpl.getTask(this.taskId).subscribe((data: any) => {
//             this.postData = data;
...
//       this.boardServiceImpl.updateTask(taskData).subscribe((data: any) => {
//           this.event.emit('OK');
