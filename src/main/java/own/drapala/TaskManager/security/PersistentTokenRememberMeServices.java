package own.drapala.TaskManager.security;
...
import own.drapala.TaskManager.service.RandomUtil;
...
public class PersistentTokenRememberMeServices extends AbstractRememberMeServices {
    ...
    private Token getPersistentToken(String[] cookieTokens) {
        ...
        Optional<Token> optionalToken = tokenRepository.findById(presentedSeries);
