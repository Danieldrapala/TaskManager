...
import own.drapala.TaskManager.repository.TokenRepository;
...
import own.drapala.TaskManager.rest.errors.InvalidPasswordException;
import own.drapala.TaskManager.rest.errors.LoginAlreadyUsedException;
import own.drapala.TaskManager.rest.vm.KeyAndPasswordVM;
import own.drapala.TaskManager.rest.vm.ManagedUserVM;
...
import own.drapala.TaskManager.service.dto.PasswordChangeDTO;
...
public class AccountResource {
    ...
    public List<Token> getCurrentSessions() {
            ...
            .ifPresent(
                u ->
                    tokenRepository
                        ...
                        .findAny()
                        .ifPresent(t -> tokenRepository.deleteById(decodedSeries))
            );
    }
